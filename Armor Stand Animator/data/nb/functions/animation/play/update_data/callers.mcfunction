## Pos
    ...
    execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.pos[0]
    ...
    execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.pos[1]
    function nb:animation/play/update_data/update_data
    ...
    execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.pos[2]
    function nb:animation/play/update_data/update_data
...
## Rotation
    ...
    execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rotation[0]
    function nb:animation/play/update_data/update_data
    ...
    execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rotation[1]
    function nb:animation/play/update_data/update_data
...
## Pose
    ## Right Arm
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightArm[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightArm[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightArm[2]
        function nb:animation/play/update_data/update_data
    ...
    ## Left Arm
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftArm[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftArm[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftArm[2]
        function nb:animation/play/update_data/update_data
    ...
    ## Right Leg
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightLeg[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightLeg[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.rightLeg[2]
        function nb:animation/play/update_data/update_data
    ...
    ## Left Leg
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftLeg[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftLeg[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.leftLeg[2]
        function nb:animation/play/update_data/update_data
    ...
    ## Head
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.head[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.head[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.head[2]
        function nb:animation/play/update_data/update_data
    ...
    ## Body
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.body[0]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.body[1]
        function nb:animation/play/update_data/update_data
        ...
        execute store result score @s nb.updDat.in.change run data get storage nb:animation smooth_move.body[2]
        function nb:animation/play/update_data/update_data
