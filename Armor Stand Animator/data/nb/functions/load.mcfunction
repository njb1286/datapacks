...
data modify storage nb:animation animations set value [{name: "My animation", repeat: 1, enforceData: true, start: {pos: [-17d, -60d, -17d], rotation: [0f, 0f]}, frames: [{time: 40, repeat: 1, params: {smooth: true}, pos: [-20.5f, -60f, -9.5f], rotation: [210f, 0f]}, {time: 40, params: {smooth: true}, repeat: 1, pos: [-16d, -60d, 3d]}]}]
