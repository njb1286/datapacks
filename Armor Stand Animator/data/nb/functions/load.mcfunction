...
data modify storage nb:animation animations set value [{name: "My animation", repeat: 1, enforceData: true, start: {pos: [-17000000d, -60000000d, -17000000d], rotation: [0f, 0f]}, frames: [{time: 10, repeat: 5, params: {smooth: true}, pos: [-20500000f, -60000000f, -9500000f], rotation: [210000000f, 0f]}]}]
